...
/**
 * Esta clase representa la interfaz gráfica para un juego de Sudoku.
 */
...
public class Interfaz extends JFrame {
    ...
    /** Panel que muestra el título del juego. */
    private JPanel panelTitulo;

    /** Etiqueta que muestra el título del juego. */
    private JLabel titulo;

    /** Etiqueta que muestra los créditos del juego. */
     ...
     * @param row       	El índice de fila de la celda.
     * @param col       	El índice de columna de la celda.
     */
    ...
    /**
     * Actualiza la interfaz gráfica con un nuevo tablero de Sudoku.
     */
    ...
    private void initComponents() {
        ...
        creditos.setText("HECHO POR JAVIER SÁEZ Y DAVID ESCRIBANO");
     ...
     *
     * @param evt 	El ActionEvent que activa el método.
     */
    ...
    {                                                   
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                if(contador == 37)	iDificultad.setDificultadSeleccionada("Fácil");
                else if(contador == 30) iDificultad.setDificultadSeleccionada("Medio");
                else if(contador == 23) iDificultad.setDificultadSeleccionada("Difícil");
                setTitle("SUDOKU : 'Nivel " + iDificultad.getDificultadSeleccionada() + "'");
    ...
    /**
     * Resuelve el rompecabezas de Sudoku actual y muestra la solución.
     *
     * @param evt 	El ActionEvent que activa el método.
     */
